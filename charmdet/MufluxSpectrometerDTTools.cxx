...
#include "TVector3.h"
  ...
  TCanvas *zoomdisp = new TCanvas("zoomdisp","Event Display T1/2 Zoom",960,768);
  zoomdisp->Range(0,-72,180,72);

  TCanvas *zoomdispback = new TCanvas("zoomdispback","Event Display T3/4 Zoom",960,960);
  ...
  for(int i=0;i<n;i++){
    ...
    double radius = RTRel.GetRadius(hit->GetDigi());
